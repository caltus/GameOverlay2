                ...
                switch (entity.Value.EntityType)
                {
                    case EntityTypes.NPC:
                        var npcIcon = entity.Value.EntitySubtype switch
                        {
                            ...
                            EntitySubtypes.AzmeriTraderNPC => this.Settings.AzmeriIcons["Unique Trader NPC"],
                            EntitySubtypes.AzmeriHarvestNPC => this.Settings.AzmeriIcons["Harvest NPC"],
                        ...
                        switch (entity.Value.EntitySubtype)
                        {
                            case EntitySubtypes.None:
                                ...
                                fgDraw.AddImage(
                                    ...
                                    chestIcon.UV1);
                                break;
                            case EntitySubtypes.ChestWithLabel:
                                ...
                                fgDraw.AddImage(
                                    ...
                                    chestIcon.UV1);
                                break;
                            case EntitySubtypes.DelveChest:
                            ...
                            case EntitySubtypes.BreachChest:
                                ...
                                fgDraw.AddImage(
                                    ...
                                    chestIcon.UV1);
                                break;
                            case EntitySubtypes.ImportantStrongbox:
                    ...
                    case EntityTypes.ImportantMiscellaneousObject:
                        var miscIcon = entity.Value.EntitySubtype switch
                        {
                            EntitySubtypes.AzmeriDustConvertor => this.Settings.AzmeriIcons["Wisp Convertor"],
                            EntitySubtypes.AzmeriLightBomb => this.Settings.AzmeriIcons["Light Bomb"],
                            EntitySubtypes.AzmeriRefuel => this.Settings.AzmeriIcons["Fuel Refill"],
                            EntitySubtypes.AzmeriPurpleWispSml => this.Settings.AzmeriIcons["Purple Wisp Sml"],
                            EntitySubtypes.AzmeriBlueWispSml => this.Settings.AzmeriIcons["Blue Wisp Sml"],
                            EntitySubtypes.AzmeriYellowWispSml => this.Settings.AzmeriIcons["Yellow Wisp Sml"],
                            EntitySubtypes.AzmeriPurpleWispMed => this.Settings.AzmeriIcons["Purple Wisp Med"],
                            EntitySubtypes.AzmeriBlueWispMed => this.Settings.AzmeriIcons["Blue Wisp Med"],
                            EntitySubtypes.AzmeriYellowWispMed => this.Settings.AzmeriIcons["Yellow Wisp Med"],
                            EntitySubtypes.AzmeriPurpleWispBig => this.Settings.AzmeriIcons["Purple Wisp Big"],
                            EntitySubtypes.AzmeriBlueWispBig => this.Settings.AzmeriIcons["Blue Wisp Big"],
                            EntitySubtypes.AzmeriYellowWispBig => this.Settings.AzmeriIcons["Yellow Wisp Big"],
                            EntitySubtypes.AbyssStartNode => this.Settings.AbyssIcons["Start"],
                            EntitySubtypes.AbyssCrack => this.Settings.AbyssIcons["Crack"],
                            EntitySubtypes.AbyssMidNode => this.Settings.AbyssIcons["Mid"],
                            EntitySubtypes.AbyssFinalNode => this.Settings.AbyssIcons["End"],
                            _ => null, // EntitySubtypes.None goes here as well
                        };

                        if (miscIcon == null)
                        {
                            this.DrawEntityPathEnding(entity.Value.Path, fgDraw, mapCenter + fpos);
                        }
                        else
                        {
                            iconSizeMultiplierVector *= miscIcon.IconScale;
                            fgDraw.AddImage(
                                miscIcon.TexturePtr,
                                mapCenter + fpos - iconSizeMultiplierVector,
                                mapCenter + fpos + iconSizeMultiplierVector,
                    ...
                    case EntityTypes.Shrine:
                        ...
                        var shrineIcon = entity.Value.EntitySubtype switch
                        {
                            EntitySubtypes.None => this.Settings.BaseIcons["Shrine"],
                            EntitySubtypes.AzmeriSacrificeAltar => this.Settings.AzmeriIcons["Sacrifice Altar"],
                            EntitySubtypes.AzmeriWell => this.Settings.AzmeriIcons["Flask Refill Well"],
                            EntitySubtypes.AzmeriExperienceGainShrine => this.Settings.AzmeriIcons["Experience Gain Shrine"],
                            EntitySubtypes.AzmeriIncreaseQuanityShrine => this.Settings.AzmeriIcons["Increase Quantity Shrine"],
                            EntitySubtypes.AzmeriCanNotBeDamagedShrine => this.Settings.AzmeriIcons["Can Not Be Damage Shrine"],
                            _ => null, // EntitySubtypes.AzmeriUnknownShrine goes here as well
                        };
                    ...
                    case EntityTypes.Monster:
                        switch (entity.Value.EntityState)
                        {
                            case EntityStates.None:
                                ...
                                else if (entity.Value.EntitySubtype == EntitySubtypes.YellowBestiaryMonster)
                                {
                                    var monsterIcon = this.Settings.BaseIcons["Yellow Bestiary Monster"];
                                ...
                                else if (entity.Value.EntitySubtype == EntitySubtypes.RedBestiaryMonster)
                                {
                                    var monsterIcon = this.Settings.BaseIcons["Red Bestiary Monster"];
                                    iconSizeMultiplierVector *= monsterIcon.IconScale;
                                    fgDraw.AddImage(
                                        monsterIcon.TexturePtr,
                                        mapCenter + fpos - iconSizeMultiplierVector,
                                ...
                                else if (entity.Value.EntitySubtype == EntitySubtypes.HarbingerMonster)
                                {
                                    var monsterIcon = this.Settings.BaseIcons["Harbinger Monster"];
                                    iconSizeMultiplierVector *= monsterIcon.IconScale;
                                    fgDraw.AddImage(
                                        monsterIcon.TexturePtr,
                                        mapCenter + fpos - iconSizeMultiplierVector,
                                ...
                                else if (entity.Value.EntitySubtype == EntitySubtypes.TormentedSpiritsMonster)
                                {
                                    var monsterIcon = this.Settings.BaseIcons["Tormented Spirits"];
                                    iconSizeMultiplierVector *= monsterIcon.IconScale;
                                    fgDraw.AddImage(
                                        monsterIcon.TexturePtr,
                                        mapCenter + fpos - iconSizeMultiplierVector,
                                ...
                                else if (entity.Value.EntitySubtype == EntitySubtypes.BetrayalEnemyNPC)
                                {
                                    var monsterIcon = this.Settings.BaseIcons["Betrayal Enemy NPC"];
                                    iconSizeMultiplierVector *= monsterIcon.IconScale;
                                    fgDraw.AddImage(
                                        monsterIcon.TexturePtr,
                                        mapCenter + fpos - iconSizeMultiplierVector,
                            ...
                            case EntityStates.MonsterFriendly:
                                ...
                                fgDraw.AddImage(
                                    ...
                                    friendlyIcon.UV1);
                                break;
                            case EntityStates.LegionStage0:
                            case EntityStates.LegionStage1Alive:
                                IconPicker monsterChestIcon = null;
                                var isOmp = entity.Value.TryGetComponent<ObjectMagicProperties>(out var OMPComp);
                                if (entity.Value.EntitySubtype == EntitySubtypes.LegionChest)
                                {
                                    monsterChestIcon = this.Settings.LegionIcons["Legion Reward Monster/Chest"];
                                }
                                else if (entity.Value.EntitySubtype == EntitySubtypes.LegionEpicChest)
                                {
                                    monsterChestIcon = this.Settings.LegionIcons["Legion Epic Chest"];
                                }
                                else if(entity.Value.EntityState == EntityStates.LegionStage0 && isOmp && OMPComp.Rarity == Rarity.Unique)
                                {
                                    monsterChestIcon = this.RarityToIconMapping(Rarity.Unique);
                                }
                                else if(entity.Value.EntityState == EntityStates.LegionStage1Alive && isOmp)
                                {
                                    monsterChestIcon = this.RarityToIconMapping(OMPComp.Rarity);
                                }

                                if (monsterChestIcon != null)
                                {
                                ...
                                break;
                            case EntityStates.LegionStage1Dead:
                            default:
                                break;
                        }
